...
import com.zaeem.mytvcast.Adapters.ImageAdapter;
import com.zaeem.mytvcast.Model.ImageModel;
...
import static com.zaeem.mytvcast.Utils.StreamingWebServer.getMimeType;
        ...
        ItemClickSupport.addTo(recyclerView).setOnItemClickListener(new ItemClickSupport.OnItemClickListener() {
            ...
            public void onItemClicked(RecyclerView recyclerView, int position, View v) {
                if(!StreamingManager.getInstance(ImageActivity.this).isDeviceConnected()){
                    startActivity(new Intent(ImageActivity.this, ConnectDeviceActivity.class));
                    return;
                }
