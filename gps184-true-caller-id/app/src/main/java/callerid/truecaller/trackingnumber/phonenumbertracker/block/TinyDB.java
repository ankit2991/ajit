...
public class TinyDB {
    ...
    private static final String INAPP_SHOWED  = "INAPP_SHOWED";
    private static final String PURCHASED_WEEKLY  = "PURCHASED_WEEKLY";
    ...
    public boolean isFirstLaunchApp() {
        return preferences.getBoolean(FIRST_LAUNCH_APP, true);
    }
    public boolean IsFirstSession() {
        return preferences.getBoolean(FIRST_SESSION, true);
    }
    ...
    public void setNotFirstLaunchApp(){

        putBoolean(FIRST_LAUNCH_APP, false);
    }

    public boolean inappsShowed() {
        return getBoolean(INAPP_SHOWED);
    }

    public void setInAppsShowed(boolean showed){

        putBoolean(INAPP_SHOWED, showed);
    }

    public boolean weeklyPurchased() {
        return getBoolean(PURCHASED_WEEKLY);
    }

    public void setWeeklyPurchased(boolean showed){

        putBoolean(PURCHASED_WEEKLY, showed);
    }
