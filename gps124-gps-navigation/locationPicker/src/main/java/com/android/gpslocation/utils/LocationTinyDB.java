...
public class LocationTinyDB {

    private SharedPreferences preferences;
    private String DEFAULT_APP_IMAGEDATA_DIRECTORY;
    private String lastImagePath = "";

    private static LocationTinyDB instance = null;

    public static LocationTinyDB getInstance(Context context) {
        if (instance != null) return instance;
        else return instance = new LocationTinyDB(context);
    }

    public LocationTinyDB(Context appContext) {
