...
public class NotifTinyDB {

    private static NotifTinyDB instance = null;
    private SharedPreferences preferences;
    private String DEFAULT_APP_IMAGEDATA_DIRECTORY;
    private String lastImagePath = "";

    public NotifTinyDB(Context appContext) {
        preferences = PreferenceManager.getDefaultSharedPreferences(appContext);
    }

    public static NotifTinyDB getInstance(@NonNull Context context) {
        if (instance != null) return instance;
        else return instance = new NotifTinyDB(context);
    }
