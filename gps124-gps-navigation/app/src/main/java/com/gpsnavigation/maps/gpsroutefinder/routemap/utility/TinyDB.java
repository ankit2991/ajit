...
public class TinyDB {
    ...
    private String isConsentGivenGDPR= "is_consent_given";

    public static final String REMOVE_ADS = "is_removed_ads";
    ...
    public static TinyDB getInstance(@NonNull Context context) {
    ...
    public int getIntDictionary(String key) {
...
*/
    ...
    public void setCurrentTime(long time) {
        preferences.edit().putLong("currentTime", time).apply();
    }

    public void setRemoveAdsPopupCount(int count) {
        preferences.edit().putInt("removeAdsPopupCount", count).apply();
    }

    public int getRemoveAdsPopupCount() {
        return preferences.getInt("removeAdsPopupCount", 0);

    }

    public int getInterstitialCount() {
        return preferences.getInt("interstitialCount", 0);

    }

    public void setInterstitialCount(int count) {
        preferences.edit().putInt("interstitialCount", count).apply();
    }


    public void setIsConsentGivenGDPR(boolean val){
        preferences.edit().putBoolean(isConsentGivenGDPR,val).commit();
    }

    public boolean getIsConsentGivenGDPR(){return  preferences.getBoolean(isConsentGivenGDPR,false);}
