...
import com.messaging.textrasms.manager.common.base.QkRealmAdapterother
...
class ConversationsOtherAdapter @Inject constructor(
    private val context: Context,
    private val dateFormatter: DateFormatter,
    private val navigator: Navigator,
    val otherFragment: other_fragment,
    private val prefs: Preferences
) : QkRealmAdapterother<Conversation>() {
...
//        setHasStableIds(true)
    ...
    companion object {
        ...
        var Clickconversationother = true
    }
...
//                                if (it) {
                                    ...
                                    when (toggleSelection(
                                        ...
                                        false -> {
                                            ...
                                            Log.d("count", "count" + i)
                                            if (Clickconversationother) {
                                                if (i == 1) {
                                                    otherFragment.adshowing(conversation.takeIf { it.isValid }?.id!!)
                                                } else {
...
//                            }
    ...
    override fun onBindViewHolder(holder: QkViewHolder, position: Int) {
        ...
        if (  !Preferences.getBoolean(context, Preferences.ADSREMOVED)  && position == 0) {
    ...
    override fun getItemId(position: Int): Long {
        return if ( !Preferences.getBoolean(context, Preferences.ADSREMOVED)&& position == 0) {
