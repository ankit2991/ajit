...
import com.messaging.textrasms.manager.common.util.TextViewStyler.Companion.SIZE_PRIMARY
import com.messaging.textrasms.manager.common.util.TextViewStyler.Companion.SIZE_SECONDARY
import com.messaging.textrasms.manager.common.util.TextViewStyler.Companion.SIZE_TERTIARY
import com.messaging.textrasms.manager.common.util.TextViewStyler.Companion.SIZE_TOOLBAR
...
class TextViewStyler @Inject constructor(
    ...
    companion object {
        ...
        fun setCustomFont(ctx: Context, asset: String, textView: TextView): Boolean {
            var tf: Typeface? = null
            try {
                tf = Typeface.createFromAsset(ctx.assets, asset)
            } catch (e: Exception) {
                Log.e("vvvvvv", "Could not get typeface: " + e.message)
                return false
            }
