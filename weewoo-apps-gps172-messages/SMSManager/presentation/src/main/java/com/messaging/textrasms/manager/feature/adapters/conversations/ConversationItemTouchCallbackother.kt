...
class ConversationItemTouchCallbackother @Inject constructor(
    colors: Colors,
    ...
    private val backgroundPaintLeft = Paint()
    private val backgroundPaintRight = Paint()
    ...
    init {
        disposables += colors.themeObservable()
            .doOnNext { theme ->
                run {
                    backgroundPaintLeft.color = theme.theme
                    backgroundPaintRight.color = context.resources.getColor(R.color.red)
                }
            }
        ...
        if (actionState == ItemTouchHelper.ACTION_STATE_SWIPE) {
            ...
            if (dX > 0) {
                c.drawRect(
                    ...
                    dX, itemView.bottom.toFloat(), backgroundPaintLeft
                )
                ...
                c.drawRect(
                    ...
                    itemView.right.toFloat(), itemView.bottom.toFloat(), backgroundPaintRight
                )
