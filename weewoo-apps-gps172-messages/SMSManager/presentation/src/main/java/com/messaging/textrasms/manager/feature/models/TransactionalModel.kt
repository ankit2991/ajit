...
class TransactionalModel @Inject constructor(
    ...
    MainState(
        page = Inbox(
            data = conversationRepo.getConversationtransactional(
                false,
                true,
                false,
                false,
        ...
        view.optionsItemIntent
            ...
            .withLatestFrom(state) { _, state ->
                android.os.Handler().postDelayed(Runnable {
                    val conversations = conversationRepo.getConversationtransactional(
                        false,
                        true,
                        false,
                        false,
