...
object Regex {
    ...
    private val URL_VALID_GTLD = "(?:(?:" +
            ...
            "watch|webcam|website|wed|wien|wiki|works|wtc|wtf|xxx|com|yachts|yokohama|zone|дети|москва|онлайн|орг|сайт|" +
    ...
    private val URL_VALID_PATH_ENDING_CHARS =
        "[a-z0-9=_#/\\-\\+$LATIN_ACCENTS_CHARS]|(?:$URL_BALANCED_PARENS)"
