...
class UnknownModel @Inject constructor(
    ...
    MainState(
        page = Inbox(
            data = conversationRepo.getConversationsUnknown(
                false,
                false
            )
        )
        ...
        view.optionsItemIntent
            ...
            .withLatestFrom(state) { _, state ->
                android.os.Handler().postDelayed(Runnable {
                    val conversations = conversationRepo.getConversationsUnknown(false, false)
    ...
    fun sorting(
        ...
        when {
            ...
            category.equals(0) -> newState {
                copy(
                    page = Inbox(
                        data = conversationRepo.sortingOfDatasortingOfDataDateunknown(
                            false,
                            false,
                            true,
                            field,
            ...
            category.equals(1) -> newState {
                copy(
                    page = Inbox(
                        data = conversationRepo.sortingOfDatasortingOfDataMonthunknown(
                            false,
                            false,
                            true,
                            field,
            ...
            category.equals(2) -> newState {
                copy(
                    page = Inbox(
                        data = conversationRepo.sortingOfDatasortingOfDataYearunknown(
                            false,
                            false,
                            true,
                            field,
