...
import com.messaging.textrasms.manager.feature.adapters.conversations.ConversationspamAdapter.Companion.isMultiSelectall
...
abstract class QkRealmAdapterspam<T : RealmModel> :
