 ...
 */
public class UserFeedbackWebservice extends NetworkCommunicationManager {

	public UserFeedbackWebservice(Context context, String user_id, String message, IWebServiceCallback callback) {
		super(context, CommonFunctions.getDomain()+ AppConstant.URL_USER_FEEDBACK, callback);
		addRequestParameters("user_id",user_id);
		addRequestParameters("message",message);
	}
