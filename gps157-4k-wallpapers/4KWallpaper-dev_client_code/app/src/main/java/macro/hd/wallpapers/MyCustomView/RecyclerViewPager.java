...
public class RecyclerViewPager extends RecyclerView {
    ...
    public void setMillisecondsPerInch(float mMillisecondsPerInch){
        this.mMillisecondsPerInch = mMillisecondsPerInch;
    }
    ...
    public void smoothScrollNativeToPosition(int position){
        super.smoothScrollToPosition(position);
    }
