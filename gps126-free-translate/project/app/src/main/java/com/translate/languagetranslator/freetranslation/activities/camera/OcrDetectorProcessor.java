...
public class OcrDetectorProcessor implements Detector.Processor<TextBlock> {
    ...
    public Detector.Detections<TextBlock> mDetections;
    ...
    public void receiveDetections(Detector.Detections<TextBlock> detections) {
        ...
        SparseArray<TextBlock> items = mDetections.getDetectedItems();
        for (int i = 0; i < items.size(); ++i) {
            TextBlock item = items.valueAt(i);
            OcrGraphic graphic = new OcrGraphic(mGraphicOverlay, item, mContext);
    ...
    public Detector.Detections<TextBlock> getAllDetectedTextBlocks() {
        return mDetections;
    }
}
