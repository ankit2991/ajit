package com.translate.languagetranslator.freetranslation.activities.fictionalLanguage.viewModel
...
class FictionalViewModel(private var dataRepository: DataRepository) : ViewModel()  {
