...
public class SimpleRatingBar extends View {
    ...
    private void initView() {
        ...
        paintStarOutline.setStrokeJoin(Paint.Join.MITER);
        paintStarOutline.setStrokeCap(Paint.Cap.SQUARE);
        ...
        paintStarBorder.setStrokeJoin(Paint.Join.MITER);
        paintStarBorder.setStrokeCap(Paint.Cap.SQUARE);
        ...
        paintStarBackground.setStrokeJoin(Paint.Join.MITER);
        paintStarBackground.setStrokeCap(Paint.Cap.SQUARE);
        ...
        paintStarFill.setStrokeJoin(Paint.Join.MITER);
        paintStarFill.setStrokeCap(Paint.Cap.SQUARE);
    ...
    private void parseAttrs(AttributeSet attrs) {
        ...
        borderColor = arr.getColor(R.styleable.SimpleRatingBar_srb_borderColor, getResources().getColor(R.color.amber_300));
