package com.lockerroom.face.features.puzzle.adapter;
...
public class PuzzleBackgroundAdapter extends RecyclerView.Adapter<PuzzleBackgroundAdapter.ViewHolder> {
    ...
    public PuzzleBackgroundAdapter(Activity context2, BackgroundChangeListener backgroundChangeListener2) {
    ...
    public PuzzleBackgroundAdapter(Activity context2, BackgroundChangeListener backgroundChangeListener2, boolean z) {
        this.context = context2;
        this.backgroundChangeListener = backgroundChangeListener2;
    ...
    public PuzzleBackgroundAdapter(Activity context2, BackgroundChangeListener backgroundChangeListener2, List<Drawable> list) {
        this.context = context2;
        this.backgroundChangeListener = backgroundChangeListener2;
