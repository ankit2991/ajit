...
public class PuzzlePiece {
    ...
    private com.lockerroom.face.features.puzzle.Area area;
    ...
    PuzzlePiece(Drawable drawable2, com.lockerroom.face.features.puzzle.Area area2, Matrix matrix2) {
    ...
    public com.lockerroom.face.features.puzzle.Area getArea() {
        return this.area;
    }
    ...
    public boolean contains(com.lockerroom.face.features.puzzle.Line line) {
    ...
    private float getMatrixScale() {
        return com.lockerroom.face.features.puzzle.MatrixUtils.getMatrixScale(this.matrix);
    }


    public float getMatrixAngle() {
        return com.lockerroom.face.features.puzzle.MatrixUtils.getMatrixAngle(this.matrix);
    }
    ...
    public boolean canFilledArea() {
        return com.lockerroom.face.features.puzzle.MatrixUtils.getMatrixScale(this.matrix) >= com.lockerroom.face.features.puzzle.MatrixUtils.getMinMatrixScale(this);
    }
    ...
    public void postRotate(float f) {
        ...
        float minMatrixScale = com.lockerroom.face.features.puzzle.MatrixUtils.getMinMatrixScale(this);
        ...
        if (!com.lockerroom.face.features.puzzle.MatrixUtils.judgeIsImageContainsBorder(this, getMatrixAngle())) {
            float[] calculateImageIndents = com.lockerroom.face.features.puzzle.MatrixUtils.calculateImageIndents(this);
    ...
    public void fillArea(View view, boolean z) {
        if (!isFilledArea()) {
            ...
            final float minMatrixScale = com.lockerroom.face.features.puzzle.MatrixUtils.getMinMatrixScale(this);
    ...
    public void updateWith(MotionEvent motionEvent, com.lockerroom.face.features.puzzle.Line line) {
        float x = (motionEvent.getX() - this.previousMoveX) / 2.0f;
        float y = (motionEvent.getY() - this.previousMoveY) / 2.0f;
        if (!canFilledArea()) {
            com.lockerroom.face.features.puzzle.Area area2 = getArea();
        ...
        if (line.direction() == com.lockerroom.face.features.puzzle.Line.Direction.HORIZONTAL) {
            translate(0.0f, y);
        } else if (line.direction() == Line.Direction.VERTICAL) {
            translate(x, 0.0f);
        }
        RectF currentDrawableBounds = getCurrentDrawableBounds();
        com.lockerroom.face.features.puzzle.Area area3 = getArea();
