...
class SlantUtils {
    ...
    static List<com.lockerroom.face.features.puzzle.slant.SlantArea> cutAreaWith(com.lockerroom.face.features.puzzle.slant.SlantArea slantArea, com.lockerroom.face.features.puzzle.slant.SlantLine slantLine) {
        ArrayList arrayList = new ArrayList();
        com.lockerroom.face.features.puzzle.slant.SlantArea slantArea2 = new com.lockerroom.face.features.puzzle.slant.SlantArea(slantArea);
        com.lockerroom.face.features.puzzle.slant.SlantArea slantArea3 = new com.lockerroom.face.features.puzzle.slant.SlantArea(slantArea);
    ...
    static com.lockerroom.face.features.puzzle.slant.SlantLine createLine(com.lockerroom.face.features.puzzle.slant.SlantArea slantArea, Line.Direction direction, float f, float f2) {
        com.lockerroom.face.features.puzzle.slant.SlantLine slantLine = new com.lockerroom.face.features.puzzle.slant.SlantLine(direction);
    ...
    static Pair<List<com.lockerroom.face.features.puzzle.slant.SlantLine>, List<com.lockerroom.face.features.puzzle.slant.SlantArea>> cutAreaWith(com.lockerroom.face.features.puzzle.slant.SlantArea slantArea, int i, int i2) {
        int i3;
        ArrayList arrayList = new ArrayList();
        ...
        for (int i4 = i + 1; i4 > 1; i4--) {
            ...
            com.lockerroom.face.features.puzzle.slant.SlantLine createLine = createLine(slantArea2, Line.Direction.HORIZONTAL, f - 0.025f, f + 0.025f);
        ...
        while (true) {
            ...
            com.lockerroom.face.features.puzzle.slant.SlantLine createLine2 = createLine(slantArea3, Line.Direction.VERTICAL, f2 + 0.025f, f2 - 0.025f);
            arrayList3.add(createLine2);
            com.lockerroom.face.features.puzzle.slant.SlantArea slantArea4 = new com.lockerroom.face.features.puzzle.slant.SlantArea(slantArea3);
            slantArea4.lineLeft = createLine2;
            slantArea4.leftTop = createLine2.start;
            slantArea4.leftBottom = createLine2.end;
            while (i3 <= arrayList2.size()) {
                com.lockerroom.face.features.puzzle.slant.SlantArea slantArea5 = new com.lockerroom.face.features.puzzle.slant.SlantArea(slantArea4);
                if (i3 == 0) {
                    slantArea5.lineTop = (com.lockerroom.face.features.puzzle.slant.SlantLine) arrayList2.get(i3);
                } else if (i3 == arrayList2.size()) {
                    slantArea5.lineBottom = (com.lockerroom.face.features.puzzle.slant.SlantLine) arrayList2.get(i3 - 1);
        ...
        while (i3 <= arrayList2.size()) {
            com.lockerroom.face.features.puzzle.slant.SlantArea slantArea6 = new com.lockerroom.face.features.puzzle.slant.SlantArea(slantArea3);
            if (i3 == 0) {
                slantArea6.lineTop = (com.lockerroom.face.features.puzzle.slant.SlantLine) arrayList2.get(i3);
            } else if (i3 == arrayList2.size()) {
                slantArea6.lineBottom = (com.lockerroom.face.features.puzzle.slant.SlantLine) arrayList2.get(i3 - 1);
    ...
    static List<com.lockerroom.face.features.puzzle.slant.SlantArea> cutAreaCross(com.lockerroom.face.features.puzzle.slant.SlantArea slantArea, com.lockerroom.face.features.puzzle.slant.SlantLine slantLine, com.lockerroom.face.features.puzzle.slant.SlantLine slantLine2) {
        ArrayList arrayList = new ArrayList();
        ...
        arrayList.add(slantArea3);
        com.lockerroom.face.features.puzzle.slant.SlantArea slantArea4 = new com.lockerroom.face.features.puzzle.slant.SlantArea(slantArea);
        ...
        com.lockerroom.face.features.puzzle.slant.SlantArea slantArea5 = new com.lockerroom.face.features.puzzle.slant.SlantArea(slantArea);
    ...
    static boolean contains(com.lockerroom.face.features.puzzle.slant.SlantArea slantArea, float f, float f2) {
    ...
    static boolean contains(com.lockerroom.face.features.puzzle.slant.SlantLine slantLine, float f, float f2, float f3) {
    ...
    static void intersectionOfLines(CrossoverPointF crossoverPointF, com.lockerroom.face.features.puzzle.slant.SlantLine slantLine, com.lockerroom.face.features.puzzle.slant.SlantLine slantLine2) {
    ...
    private static boolean isHorizontalLine(com.lockerroom.face.features.puzzle.slant.SlantLine slantLine) {
        return slantLine.start.y == slantLine.end.y;
    }

    private static boolean isVerticalLine(com.lockerroom.face.features.puzzle.slant.SlantLine slantLine) {
        return slantLine.start.x == slantLine.end.x;
    }

    private static boolean isParallel(com.lockerroom.face.features.puzzle.slant.SlantLine slantLine, com.lockerroom.face.features.puzzle.slant.SlantLine slantLine2) {
        return calculateSlope(slantLine) == calculateSlope(slantLine2);
    }

    static float calculateSlope(com.lockerroom.face.features.puzzle.slant.SlantLine slantLine) {
    ...
    private static float calculateVerticalIntercept(com.lockerroom.face.features.puzzle.slant.SlantLine slantLine) {
        if (isHorizontalLine(slantLine)) {
