...
import com.lockerroom.face.features.puzzle.SquarePuzzleView;
import com.lockerroom.face.features.puzzle.layout.slant.NumberSlantLayout;
import com.lockerroom.face.features.puzzle.layout.straight.NumberStraightLayout;
...
public class PuzzleAdapter extends RecyclerView.Adapter<PuzzleAdapter.PuzzleViewHolder> {
    ...
    public void onBindViewHolder(PuzzleViewHolder puzzleViewHolder, final int i) {
        ...
        if (this.selectedIndex == i) {
            puzzleViewHolder.puzzleView.setBackgroundColor(Color.parseColor("#ccf1d2"));
        } else {
