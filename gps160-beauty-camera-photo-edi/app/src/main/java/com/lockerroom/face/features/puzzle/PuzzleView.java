...
public class PuzzleView extends StickerView {
    ...
    private Map<com.lockerroom.face.features.puzzle.Area, PuzzlePiece> areaPieceMap;
    ...
    private com.lockerroom.face.features.puzzle.Line handlingLine;
    ...
    public void onSizeChanged(int i, int i2, int i3, int i4) {
        ...
        if (this.puzzlePieces.size() != 0) {
            for (int i5 = 0; i5 < this.puzzlePieces.size(); i5++) {
                ...
                com.lockerroom.face.features.puzzle.Area area = this.puzzleLayout.getArea(i5);
        ...
        if (this.puzzleLayout != null) {
            ...
            if (this.initialInfo != null) {
                ...
                for (int i = 0; i < size; i++) {
                    ...
                    com.lockerroom.face.features.puzzle.Line line = this.puzzleLayout.getLines().get(i);
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (this.puzzleLayout != null) {
            ...
            if (this.needDrawOuterLine) {
                for (com.lockerroom.face.features.puzzle.Line drawLine : this.puzzleLayout.getOuterLines()) {
                    drawLine(canvas, drawLine);
                }
            }
            if (this.needDrawLine) {
                for (com.lockerroom.face.features.puzzle.Line drawLine2 : this.puzzleLayout.getLines()) {
    ...
    private void drawSelectedArea(Canvas canvas, PuzzlePiece puzzlePiece) {
        com.lockerroom.face.features.puzzle.Area area = puzzlePiece.getArea();
        canvas.drawPath(area.getAreaPath(), this.selectedAreaPaint);
        for (com.lockerroom.face.features.puzzle.Line next : area.getLines()) {
    ...
    private void drawLine(Canvas canvas, com.lockerroom.face.features.puzzle.Line line) {
    ...
    private void moveLine(com.lockerroom.face.features.puzzle.Line line, MotionEvent motionEvent) {
        boolean z;
    ...
    private void updatePiecesInArea(com.lockerroom.face.features.puzzle.Line line, MotionEvent motionEvent) {
    ...
    private com.lockerroom.face.features.puzzle.Line findHandlingLine() {
