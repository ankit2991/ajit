...
public class PermissionsUtils {
    ...
    public static boolean checkReadStoragePermission13(Activity activity) {
        boolean z = true;
        if (Build.VERSION.SDK_INT < 16) {
            return true;
        }
        ...
        if (!z) {
            ActivityCompat.requestPermissions(activity, PermissionsConstant.PERMISSIONS_REAN_MEDIA_IMAGES, 2);
        }
        return z;
    }
