...
public abstract class StraightPuzzleLayout implements PuzzleLayout {
    private Comparator<com.lockerroom.face.features.puzzle.straight.StraightArea> areaComparator = new com.lockerroom.face.features.puzzle.straight.StraightArea.AreaComparator();
    private List<com.lockerroom.face.features.puzzle.straight.StraightArea> areas = new ArrayList();
    private RectF bounds;
    private int color = -1;
    private List<Line> lines = new ArrayList();
    private com.lockerroom.face.features.puzzle.straight.StraightArea outerArea;
    ...
    public List<com.lockerroom.face.features.puzzle.straight.StraightArea> getAreas() {
        return this.areas;
    }

    public Comparator<com.lockerroom.face.features.puzzle.straight.StraightArea> getAreaComparator() {
    ...
    public void setOuterBounds(RectF rectF) {
        ...
        com.lockerroom.face.features.puzzle.straight.StraightLine straightLine = new com.lockerroom.face.features.puzzle.straight.StraightLine(pointF, pointF3);
        com.lockerroom.face.features.puzzle.straight.StraightLine straightLine2 = new com.lockerroom.face.features.puzzle.straight.StraightLine(pointF, pointF2);
        com.lockerroom.face.features.puzzle.straight.StraightLine straightLine3 = new com.lockerroom.face.features.puzzle.straight.StraightLine(pointF2, pointF4);
        com.lockerroom.face.features.puzzle.straight.StraightLine straightLine4 = new com.lockerroom.face.features.puzzle.straight.StraightLine(pointF3, pointF4);
        ...
        this.outerArea = new com.lockerroom.face.features.puzzle.straight.StraightArea();
    ...
    public com.lockerroom.face.features.puzzle.straight.StraightArea getOuterArea() {
        return this.outerArea;
    }

    public void setPadding(float f) {
        this.padding = f;
        for (com.lockerroom.face.features.puzzle.straight.StraightArea padding2 : this.areas) {
    ...
    private List<com.lockerroom.face.features.puzzle.straight.StraightArea> addLine(com.lockerroom.face.features.puzzle.straight.StraightArea straightArea, Line.Direction direction, float f) {
        this.areas.remove(straightArea);
        com.lockerroom.face.features.puzzle.straight.StraightLine createLine = com.lockerroom.face.features.puzzle.straight.StraightUtils.createLine(straightArea, direction, f);
        this.lines.add(createLine);
        List<com.lockerroom.face.features.puzzle.straight.StraightArea> cutArea = com.lockerroom.face.features.puzzle.straight.StraightUtils.cutArea(straightArea, createLine);
    ...
    public void cutAreaEqualPart(int i, int i2, Line.Direction direction) {
        int i3;
        com.lockerroom.face.features.puzzle.straight.StraightArea straightArea = this.areas.get(i);
        int i4 = i2;
        while (true) {
            i3 = 0;
            if (i4 <= 1) {
    ...
    public void addCross(int i, float f, float f2) {
        com.lockerroom.face.features.puzzle.straight.StraightArea straightArea = this.areas.get(i);
        this.areas.remove(straightArea);
        com.lockerroom.face.features.puzzle.straight.StraightLine createLine = com.lockerroom.face.features.puzzle.straight.StraightUtils.createLine(straightArea, Line.Direction.HORIZONTAL, f);
        com.lockerroom.face.features.puzzle.straight.StraightLine createLine2 = com.lockerroom.face.features.puzzle.straight.StraightUtils.createLine(straightArea, Line.Direction.VERTICAL, f2);
        this.lines.add(createLine);
        this.lines.add(createLine2);
        this.areas.addAll(com.lockerroom.face.features.puzzle.straight.StraightUtils.cutAreaCross(straightArea, createLine, createLine2));
        updateLineLimit();
        sortAreas();
        Step step = new Step();
        step.hRatio = f;
    ...
    public void cutAreaEqualPart(int i, int i2, int i3) {
        com.lockerroom.face.features.puzzle.straight.StraightArea straightArea = this.areas.get(i);
        this.areas.remove(straightArea);
        Pair<List<com.lockerroom.face.features.puzzle.straight.StraightLine>, List<com.lockerroom.face.features.puzzle.straight.StraightArea>> cutArea = com.lockerroom.face.features.puzzle.straight.StraightUtils.cutArea(straightArea, i2, i3);
    ...
    public void cutSpiral(int i) {
        com.lockerroom.face.features.puzzle.straight.StraightArea straightArea = this.areas.get(i);
        this.areas.remove(straightArea);
        Pair<List<com.lockerroom.face.features.puzzle.straight.StraightLine>, List<com.lockerroom.face.features.puzzle.straight.StraightArea>> cutAreaSpiral = com.lockerroom.face.features.puzzle.straight.StraightUtils.cutAreaSpiral(straightArea);
    ...
    public void setRadian(float f) {
        this.radian = f;
        for (com.lockerroom.face.features.puzzle.straight.StraightArea radian2 : this.areas) {
            radian2.setRadian(f);
        }
    }
