...
public class Constants {
    ...
    public static boolean   IS_SHOW_REWARDED_AD = true;
    public static boolean   IS_SHOW_REWARDED_AD_FILTER = true;
    public static boolean   IS_SHOW_REWARDED_AD_STICKER = true;
    public static boolean   IS_SHOW_REWARDED_AD_SPLASH = true;
    public static boolean   IS_SHOW_REWARDED_AD_BEAUTY= true;
