...
public interface PuzzleLayout {
    ...
    com.lockerroom.face.features.puzzle.Area getArea(int i);

    int getAreaCount();

    int getColor();

    List<com.lockerroom.face.features.puzzle.Line> getLines();

    Area getOuterArea();

    List<com.lockerroom.face.features.puzzle.Line> getOuterLines();
    ...
    class Info implements Parcelable {
        ...
        public ArrayList<com.lockerroom.face.features.puzzle.Line> lines;
    ...
    class Step implements Parcelable {
        ...
        public com.lockerroom.face.features.puzzle.Line.Direction lineDirection() {
            return this.direction == 0 ? com.lockerroom.face.features.puzzle.Line.Direction.HORIZONTAL : com.lockerroom.face.features.puzzle.Line.Direction.VERTICAL;
        }
