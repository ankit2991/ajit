...
public class PuzzleLayoutParser {
    ...
    public static com.lockerroom.face.features.puzzle.PuzzleLayout parse(final com.lockerroom.face.features.puzzle.PuzzleLayout.Info info) {
        com.lockerroom.face.features.puzzle.PuzzleLayout puzzleLayout;
        if (info.type == 0) {
            puzzleLayout = new StraightPuzzleLayout() {
                public com.lockerroom.face.features.puzzle.PuzzleLayout clone(com.lockerroom.face.features.puzzle.PuzzleLayout puzzleLayout) {
                    return null;
                }
